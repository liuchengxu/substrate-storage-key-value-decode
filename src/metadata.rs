// Copied from https://github.com/paritytech/substrate-subxt/blob/master/src/metadata.rs
//
// Expose some fields in structs
...
pub struct Metadata {
    ...
    pub modules_with_errors: HashMap<String, ModuleWithErrors>,
}
